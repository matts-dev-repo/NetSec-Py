...
f2 = open('Matt-VPN-September.csv') #Just change the CSV value to the path of the CSV. This is only input portion
...
#Cleans all the duplicate entries in each day
